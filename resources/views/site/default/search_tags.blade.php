...
@section('content')
    <section class="viewNews wow fadeInUp" data-wow-offset="300">
        ...
        <div class="RelatedNews">
            <div class="container">
                <h1 class="titleLine"><span class="line"></span><span class="title orange">Tags</span><span class="line"></span></h1>
                ...
                @foreach ($posts as $post)
                    ...
                    <div class="itemList row wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="col-md-8 col-sm-8">
                            <h3 class="tl">
                                <a href="{{ route('post', ['cate_slug' => ($languageCurrent == 'vn') ? 'tin-tuc' : 'news', 'post_slug' => $post->slug, 'languageCurrent' => $languageCurrent]) }}">{{ $post->title }}
                            ...
                            <div class="more tl"><a class="BtnBlack" href="{{ route('post', ['cate_slug' => ($languageCurrent == 'vn') ? 'tin-tuc' : 'news', 'post_slug' => $post->slug, 'languageCurrent' => $languageCurrent]) }}">{{ $languageSetup['doc-them'] }}</a></div>
                        </div>
                    </div>
                @endforeach
